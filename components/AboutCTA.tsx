    ...
    <section className="relative w-full bg-white py-20 px-6 md:py-28 md:px-16 overflow-hidden border-t border-zinc-100">
      <div className="w-full mx-auto flex flex-col items-center text-center">
        ...
        <div className="flex flex-row gap-4 mt-8 md:mt-10">
          <button className="bg-[#0b0742] text-white font-semibold px-8 py-3.5 rounded-full hover:bg-opacity-90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-sm md:text-base shadow-md cursor-pointer">
            Offline Training
          </button>
          <button className="bg-[#0b0742] text-white font-semibold px-8 py-3.5 rounded-full hover:bg-opacity-90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-sm md:text-base shadow-md cursor-pointer">
            Online Session
